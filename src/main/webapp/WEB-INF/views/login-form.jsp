...
<body>
	<div class="login">
		<img src="/img-dj/fantasy-gb3940483a_1280.jpg" alt="login image"
			class="login__img">

		<form action="/account/login" class="login__form" method="post">
			...
			<div class="login__content">
				<div class="login__box">
					...
					<div class="login__box-input">
						<input type="text" required class="login__input" name="username"
							placeholder=" "> <label for="" class="login__label">Email</label>
					</div>
				</div>
				...
				<div class="login__box">
					...
					<div class="login__box-input">
						<input name="password" type="password" required
							...
							for="" class="login__label">Password</label> <i
			...
			<p class="login__register">
				Don't have an account? <a href="/account/register1">Register</a>
			</p>
		</form>
	</div>
