			...
			<main class="content px-3 py-2">
				<div class="container-fluid">
					<div class="mb-3">
						...
						<h2 class="font-monospace fw-bold text-white text-center">LIST
							CATEGORY</h2>
						<div class="row">
							<div class="col-md-2 row">
								<div class="col-md-11">
								<label class="font-monospace fw-bold text-white">Kích thức trang</label>
								</div>
								<div class="col-md-1">
								 <input class="form-control" style="width: 50px" placeholder="${page.numberOfElements }">  
								</div>
							</div>
							<div class="col-md-2 row">
								<div class="col-md-11">
								<label class="font-monospace fw-bold text-white">Số trang</label>
								</div>
								<div class="col-md-1">
								 <input class="form-control" style="width: 50px" placeholder="${page.number }">  
								</div>
							</div>
							<div class="col-md-2 row">
								<div class="col-md-11">
								<label class="font-monospace fw-bold text-white">Tổng sản phẩm</label>
								</div>
								<div class="col-md-1">
								 <input class="form-control" style="width: 50px" placeholder="${page.totalElements }">  
								</div>
							</div>
						</div>
						<table class="table text-white table-dark table-striped mt-4"
						...
						<div class="text-center">
							<a href="/category/page?page=0"
								class="btn btn-outline-warning p-1"> |< </a> <a
								href="/category/page?page=${page.number -1 }"
								class="btn btn-outline-warning p-1"> << </a> <a
								href="/category/page?page=${page.number +1 }"
								class="btn btn-outline-warning p-1"> >> </a> <a
								href="/category/page?page=${page.totalPages -1 }"
								class="btn btn-outline-warning p-1"> >| </a>
