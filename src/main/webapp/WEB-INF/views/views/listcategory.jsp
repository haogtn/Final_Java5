		...
		<div class="main">
			...
			<main class="content px-3 py-2">
				<div class="container-fluid">
					...
					<h2 class="font-monospace fw-bold text-white text-center">LIST PRODUCT</h2>
						...
						<table class="table text-white table-dark table-striped">
							...
							<tbody>
								<c:forEach items="${PRODUCTS}" var="ac">
								<tr>
									<td class="align-middle">${ac.id}</td>
									<td> <img alt="" src="/img-dj/${ac.image}" width="100px" height="100px"> </td>
									<td class="align-middle">${ac.name}</td>
									<td class="align-middle"> ${ac.createDate}</td>
									<td class="align-middle"> ${ac.category.name}</td>
									<td class="align-middle">${ac.price}</td>
									<td class="align-middle">${ac.activated?"Chưa có hàng":"Đã có hàng"}</td>
									<td class=""><a href="?btnDel=&id=${ac.id}" class="btn btn-outline-warning m-1">Xóa</a><a href="/product/views/${ac.id}" class="btn btn-outline-warning m-1">Edit</a> </td>
					...
					<a href="/product/index" class="btn btn-outline-warning p-1"> Thêm</a>
