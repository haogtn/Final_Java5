		...
		<div class="main">
			...
			<main class="content px-3 py-2">
				<div class="container-fluid">
					...
					<h2 class="font-monospace fw-bold text-white text-center">LIST PROFILE</h2>
						...
						<table class="table text-white table-dark table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td> <img alt="" src="/img-dj/${ac.photo}" width="100px" height="100px"> </td>
									<td class="align-middle">${ac.username}</td>
									<td class="align-middle">${ac.password}</td>
									<td class="align-middle"> ${ac.fullname}</td>
									<td class="align-middle">${ac.email}</td>
									<td class="align-middle">${ac.phone}</td>
									<td class="align-middle">${ac.faculty}</td>
									<td class="align-middle">${ac.gender}</td>
									<td class="align-middle">${ac.activated?"Online":"Offline"}</td>
									<td class="align-middle">${ac.admin?"Admin":"User"}</td>
									<td class=""><a href="?btnDel=&username=${ac.username}" class="btn btn-outline-warning m-1">Xóa</a><a href="/account/register/${ac.username}" class="btn btn-outline-warning m-1">Edit</a> </td>
								</tr>
						</c:forEach>     
							</tbody>
						</table>
						 <div class="text-center">
					<a href="/account/register" class="btn btn-outline-warning p-1"> Thêm</a>
